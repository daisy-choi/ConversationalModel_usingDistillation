...
class TranslationBuilder(object):
    ...
    def from_batch(self, translation_batch):
        ...
        enc_out, preds, pred_score, attn, gold_score, indices = list(zip(
            *sorted(zip(translation_batch["enc_out"],
...
class Translation(object):
    ...
    def __init__(self, src, src_raw, pred_sents,
                 attn, pred_scores, tgt_sent, gold_score, enc_out = None):
        self.src = src
